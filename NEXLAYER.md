...
**Live:** [https://relaxed-weasel-twenty.cloud.nexlayer.ai](https://relaxed-weasel-twenty.cloud.nexlayer.ai)  
...
**twenty** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: server
    image: mirror.gcr.io/twentycrm/twenty:latest
    path: /
    servicePorts:
    - 3000
    vars:
      DATABASE_PG_URL: "postgres://twenty:${POSTGRES_PASSWORD}@postgres.pod:5432/default"
      REDIS_URL: "redis://redis.pod:6379"
      APP_SECRET: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2"
      FRONT_BASE_URL: "https://relaxed-weasel-twenty.cloud.nexlayer.ai"
    ...
    - name: twenty-data
      ...
      size: 5Gi
  - name: postgres
    image: mirror.gcr.io/twentycrm/twenty-postgres:latest
    servicePorts:
    - 5432
    vars:
